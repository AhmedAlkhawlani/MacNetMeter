...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AppNetworkService appNetworkService = new AppNetworkService(); // خدمة تتبع البرامج 🌟
        ...
        Runnable resetTodayAction = () -> {
            ...
            refreshNet(netWidget, caffeinateService, alertService, sysInfoService, appNetworkService, null);
        };

        refreshNet(netWidget, caffeinateService, alertService, sysInfoService, appNetworkService, resetTodayAction);
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                // تحديث قائمة الشبكة بالبرامج الحية
                refreshNet(netWidget, caffeinateService, alertService, sysInfoService, appNetworkService, resetTodayAction);

                // 2. تحديث المعالج والرام
    ...
    private static void refreshNet(TrayIcon widget, CaffeinateService caffeinate, AlertService alerts,
                                   SystemInfoService sysInfo, AppNetworkService appNet, Runnable onResetToday) {
        widget.setPopupMenu(MenuBuilder.build(caffeinate, alerts, sysInfo, appNet, currentMode,
                () -> refreshNet(widget, caffeinate, alerts, sysInfo, appNet, onResetToday),
                onResetToday,
                m -> {
                    currentMode = m;
                    refreshNet(widget, caffeinate, alerts, sysInfo, appNet, onResetToday);
